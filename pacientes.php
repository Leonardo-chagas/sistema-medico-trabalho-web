...
<html>
    ...
    <body id="background">
        ...
        <ul id="navbar">
            ...
            <li class="nav"><a id="active" href="pacientes.php">Pacientes</a></li>
        ...
        <div id="dados">
            <table style="position: relative; top: 0; bottom: 0; left: 0; right: 0; width: 100%;" id="contents">
                <tr style="font-weight: bold;"> <th>Nome</th> <th>Endereço</th> <th>Telefone</th> <th>E-mail</th> <th>Gênero</th> <th>Idade</th> <th>CPF</th> </tr>
                <?php
                    $server = 'localhost';
                    $user = 'root';
                    $password = '';
                    ...
                    foreach($data as $row){
                        echo "<tr> <th>".$row['nome']."</th> <th>".$row['endereço']."</th> <th>".$row['telefone']."</th> <th>".$row['email']."</th> <th>".$row['genero']."</th> <th>".$row['idade']."</th> <th>".$row['cpf']."</th> </tr>";
                    }
                    $conn = null;
                ?>
            </table>
